...
public class ListLavadora extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTableListLavadora = new javax.swing.JTable();
        ...
        jLabel1.setText("Listar Lavadora");

        jTableListLavadora.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Capacidad", "Consumo De Agua", "Nombre", "Codigo", "Alto", "Ancho", "Largo", "Color", "Precio", "Marca", "Watts Por Hora"
            }
        ) {
            Class[] types = new Class [] {
                java.lang.Double.class, java.lang.Double.class, java.lang.String.class, java.lang.String.class, java.lang.Double.class, java.lang.Double.class, java.lang.Double.class, java.lang.String.class, java.lang.Double.class, java.lang.String.class, java.lang.Double.class
            };
        ...
        jScrollPane2.setViewportView(jTableListLavadora);
        if (jTableListLavadora.getColumnModel().getColumnCount() > 0) {
            jTableListLavadora.getColumnModel().getColumn(0).setMinWidth(100);
            jTableListLavadora.getColumnModel().getColumn(1).setMinWidth(150);
            jTableListLavadora.getColumnModel().getColumn(10).setMinWidth(150);
        }
